...
const (
	...
	NotificationServiceSendNotificationProcedure = "/notification.v1.NotificationService/SendNotification"
...
func (UnimplementedNotificationServiceHandler) SendNotification(context.Context, *connect.Request[v1.SendNotificationRequest]) (*connect.Response[v1.SendNotificationResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("notification.v1.NotificationService.SendNotification is not implemented"))
}
